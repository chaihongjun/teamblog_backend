<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"D:\xampp\htdocs\backend\themes/admin/category\add.html";i:1590745590;s:46:"D:\xampp\htdocs\backend\themes\admin\base.html";i:1590538902;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/category/save'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                          <input type="text" name="dir" value="" placeholder="请输入对应目录名称(英文比如: news)" class="layui-input">
                      </div>
                  </div>
                    <div class="layui-form-item">
