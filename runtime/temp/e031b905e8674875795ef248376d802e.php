<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"D:\xampp\htdocs\backend\themes/admin/article\add.html";i:1590564861;s:46:"D:\xampp\htdocs\backend\themes\admin\base.html";i:1590538902;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="layui-tab-content">
      <div class="layui-tab-item layui-show">
        <form
          ...
          action="<?php echo url('admin/article/save'); ?>"
          method="post"
        >
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <button type="button" id="upload-photo-btn" class="layui-btn">
                上传图集
              </button>
    ...
    uploadEditor.ready(function () {
      ...
      uploadEditor.addListener("beforeInsertImage", function (t, arg) {
        $.each(arg, function (index, item) {
          photoListItem =
            '<div class="photo-list"><input type="text" name="photo[]" value="' +
            item.src +
            '" class="layui-input layui-input-inline">';
          photoListItem +=
          ...
          $("#photo-container")
            .append(photoListItem)
            .on("click", ".remove-photo-btn", function () {
