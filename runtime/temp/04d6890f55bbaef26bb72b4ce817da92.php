<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"./themes/default/index\index.html";i:1566981859;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <title>素材牛 - 基于ThinkPHP5开发的开源后台管理系统</title>
    <meta name="description" content="基于ThinkPHP5开发的开源后台管理系统">
    <link rel="stylesheet" href="/public/static/js/layui/css/layui.css">
    <style>
        .header {
            width: 100%;
            height: 400px;
            background: url(/public/static/images/login-bg.png) #56bc94;
            text-align: center;
        }
    ...
    <div class="top-nav">
        <div class="layui-main">
            ...
            <ul class="layui-nav">
                ...
                <li class="layui-nav-item"><a href="/admin" target="_blank">后台演示</a></li>
                <li class="layui-nav-item"><a href="http://www.sucainiu.com" target="_blank">素材牛</a></li>
            </ul>
        </div>
    </div>

    <a href="http://www.sucainiu.com/thinkphp5-layui.html" target="_blank" class="download-btn">下 载 （v1.1.1）</a>
...
<div class="layui-main content">
    ...
    <p>2016-2019 © www.sucainiu.com</p>
</div>
