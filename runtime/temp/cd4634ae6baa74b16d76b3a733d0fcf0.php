<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\xampp\htdocs\backend\themes/admin/category\index.html";i:1590746530;s:46:"D:\xampp\htdocs\backend\themes\admin\base.html";i:1590538902;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                ----';} endif; ?> <?php echo $vo['name']; ?>
              </td>
              <td><?php echo $vo['dir']; ?></td>
              <td>
                <a
                  href="<?php echo url('admin/category/add',['pid'=>$vo['id']]); ?>"
                  class="layui-btn layui-btn-mini"
                  >添加子栏目</a
                >
                <a
                  href="<?php echo url('admin/category/edit',['id'=>$vo['id']]); ?>"
                  class="layui-btn layui-btn-normal layui-btn-mini"
                  >编辑</a
                >
                <a
                  href="<?php echo url('admin/category/delete',['id'=>$vo['id']]); ?>"
                  class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"
                  >删除</a
                >
              </td>
            </tr>
