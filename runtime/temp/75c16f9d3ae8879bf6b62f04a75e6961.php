<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"D:\xampp\htdocs\backend\themes/admin/menu\index.html";i:1590539298;s:46:"D:\xampp\htdocs\backend\themes\admin\base.html";i:1590538902;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                ----';} endif; ?> <?php echo $vo['title']; ?>
              </td>
              <td><?php echo $vo['name']; ?></td>
              <td><?php echo $vo['status']==1 ? '显示' : '隐藏'; ?></td>
              <td>
                <a
                  href="<?php echo url('admin/menu/add',['pid'=>$vo['id']]); ?>"
                  class="layui-btn layui-btn-mini"
                  >添加子菜单</a
                >
                <a
                  href="<?php echo url('admin/menu/edit',['id'=>$vo['id']]); ?>"
                  class="layui-btn layui-btn-normal layui-btn-mini"
                  >编辑</a
                >
                <a
                  href="<?php echo url('admin/menu/delete',['id'=>$vo['id']]); ?>"
